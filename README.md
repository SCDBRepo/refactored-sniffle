...
-->
# @scdb/refactored-sniffle 5.98.0
...
# <a href="https://stonecypher.github.io/@scdb/refactored-sniffle-viz-demo/graph_explorer.html" target="_blank" rel="noopener noreferrer">TRY THE LIVE EDITOR</a>

<a href="https://discord.gg/9P95USqnMK">Discord community</a> - <a href="https://stonecypher.github.io/@scdb/refactored-sniffle/docs/">Documentation</a> - <a href="https://github.com/StoneCypher/fsl/issues">Issue tracker</a> - <a href="https://github.com/SCDBRepo/refactored-sniffle/actions">CI build history</a>
...
```javascript
import { sm } from '@scdb/refactored-sniffle';
...
<img src="https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/doc%20light%20unstyled.png"/>
...
<img src="https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/doc%20light%20styled.png"/>

<br/>

What if the machine was lighting fast, able to do tens of millions of transitions per second?

<img src="https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/speed%20claim.png"/>

<br/>

* What if the machine and language had [extensive 100% test coverage](https://coveralls.io/github/StoneCypher/@scdb/refactored-sniffle)
  with [thousands of cases](https://github.com/SCDBRepo/refactored-sniffle/tree/main/src/ts/tests)?
...
[Try it live!](https://stonecypher.github.io/@scdb/refactored-sniffle-viz-demo/graph_explorer.html)

Visualize with [@scdb/refactored-sniffle-viz](https://github.com/SCDBRepo/refactored-sniffle-viz), or at the command line with [@scdb/refactored-sniffle-viz-cli](https://github.com/SCDBRepo/refactored-sniffle-viz-cli).
...
[![Actions Status](https://github.com/SCDBRepo/refactored-sniffle/workflows/Node%20CI/badge.svg)](https://github.com/SCDBRepo/refactored-sniffle/actions)

[![GitHub forks](https://img.shields.io/github/forks/StoneCypher/@scdb/refactored-sniffle.svg?style=social&label=Fork%20JSSM)]()
[![GitHub watchers](https://img.shields.io/github/watchers/StoneCypher/@scdb/refactored-sniffle.svg?style=social&label=Watch%20JSSM)]()
[![GitHub stars](https://img.shields.io/github/stars/StoneCypher/@scdb/refactored-sniffle.svg?style=social&label=JSSM%20Stars)]()
[![GitHub followers](https://img.shields.io/github/followers/StoneCypher.svg?style=social&label=Follow%20StoneCypher)]()

[![License](https://img.shields.io/npm/l/@scdb/refactored-sniffle.svg)](https://github.com/SCDBRepo/refactored-sniffle/blob/master/LICENSE.md)
[![Open issues](https://img.shields.io/github/issues/StoneCypher/@scdb/refactored-sniffle.svg)](https://github.com/SCDBRepo/refactored-sniffle/issues)
[![Closed issues](https://img.shields.io/github/issues-closed/StoneCypher/@scdb/refactored-sniffle.svg)](https://github.com/SCDBRepo/refactored-sniffle/issues?q=is%3Aissue+is%3Aclosed)
[![Travis status](https://img.shields.io/travis/StoneCypher/@scdb/refactored-sniffle.svg)](https://travis-ci.org/StoneCypher/@scdb/refactored-sniffle)
[![Coveralls status](https://img.shields.io/coveralls/StoneCypher/@scdb/refactored-sniffle.svg)](https://coveralls.io/github/StoneCypher/@scdb/refactored-sniffle)

[![NPM version](https://img.shields.io/npm/v/@scdb/refactored-sniffle.svg)](https://www.npmjs.com/package/@scdb/refactored-sniffle)
[![CDNjs version](https://img.shields.io/cdnjs/v/jquery.svg)](https://img.shields.io/cdnjs/v/jquery.svg)
[![NPM downloads](https://img.shields.io/npm/dt/@scdb/refactored-sniffle.svg)](https://www.npmjs.com/package/@scdb/refactored-sniffle)

<img src="https://starchart.cc/StoneCypher/@scdb/refactored-sniffle.svg" width="50%">
...
This will produce the following FSM (graphed with [@scdb/refactored-sniffle-viz](https://github.com/SCDBRepo/refactored-sniffle-viz)):

![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/ryg%20proceed.png)

You'll build an executable state machine.

![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/ryg%20traffic%20light%20console%20screenshot.png)
...
`DSL`'s parser's original name was `@scdb/refactored-sniffle-dot`, because it's a descendant-in-spirit of an older flowcharting language
[DOT](http://www.graphviz.org/content/dot-language), from [graphviz](graphviz.org), which is also used to make the
visualizations in [@scdb/refactored-sniffle-viz](https://github.com/SCDBRepo/refactored-sniffle-viz) by way of [viz-js](viz-js.com).
...
[graph explorer](https://stonecypher.github.io/@scdb/refactored-sniffle-viz-demo/graph_explorer.html) for an opportunity to mess with the
code as you see fit.
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/traffic%20light%20quick%20start%20tutorial/Off%20To%20Red.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/traffic%20light%20quick%20start%20tutorial/Off%20To%20RGY.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/traffic%20light%20quick%20start%20tutorial/Off%20To%20From%20RGY.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/ncsu%20atm%20diagram.gif)
...
We'll start with an [empty machine](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/machines/atm%20quick%20start%20tutorial/1_EmptyWaiting.@scdb/refactored-sniffle).

```fsl
EmptyWaiting 'Wait' -> EmptyWaiting;
```

![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/0_EmptyWaiting.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/1_EjectCard.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/2_InsertCard.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/3_ReturnCard.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/4_WrongPin.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/5_RightPin.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/6_CanCheckBalance.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/7_CanDepositMoney.png)
...
![](https://raw.githubusercontent.com/StoneCypher/@scdb/refactored-sniffle/master/src/assets/atm%20quick%20start%20tutorial/8_CanWithdrawMoney.png)
...
* [Mykhaylo Les](https://github.com/miles91) provided three translation test cases ([Ukrainian](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/ukrainian.json), [Belarussian](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/belarussian.json), and [Russian](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/russian.json),) and the corresponding Traffic Light translations (also [Ukrainian](https://github.com/StoneCypher/fsl_traffic_light_ukrainian/blob/master/traffic%20light.fsl), [Belarussian](https://github.com/StoneCypher/fsl_traffic_light_belarussian/blob/master/traffic_light.fsl), and [Russian](https://github.com/StoneCypher/fsl_traffic_light_russian/blob/master/traffic%20light.fsl).)
* [Tanvir Islam](https://github.com/tanvirrb) provided the [Bengali test case](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/bengali.json), translated the [Traffic Light](https://github.com/tanvirrb/fsl-traffic-light-bengali/blob/master/traffic_light.fsl) to Bengali, and published the first non-English `FSL` machine, in Bengali.
* [Francisco Junior](https://github.com/fcojr) provided the [Portuguese test case](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/portuguese.json) and translated the [Traffic Light](https://github.com/StoneCypher/fsl_traffic_light_portuguese/blob/master/traffic_light.fsl) to Portuguese
* [Jeff Katz](https://github.com/kraln) provided the [German test case](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/german.json).
* [Alex Cresswell](https://github.com/technophile77) provdied the [Spanish test case](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/spanish.json)
* [Dvir Cohen](https://github.com/cohendvir) provided the [Hebrew test case](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/hebrew.json).
* [David de la Peña](https://github.com/daviddelapena) provided the [French test case](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/french.json)

If I've overlooked you, please let me know.

If you'd like to help, it's straightforward.

1. Easy mode: open a PR with [this file](https://github.com/SCDBRepo/refactored-sniffle/blob/master/src/js/tests/language_data/english.json) translated into your language
